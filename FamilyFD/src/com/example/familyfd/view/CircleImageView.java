...
public class CircleImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		/** 锟斤拷drawable锟襟定碉拷bitmap(this.mask)锟斤拷锟芥（drawable只锟斤拷通锟斤拷bitmap锟斤拷示锟斤拷锟斤拷锟斤拷 */
		localDraw.draw(canvas);
		if ((this.mask == null) || (this.mask.isRecycled())) {
			this.mask = createOvalBitmap(width, height);
		}
		/** 锟斤拷bitmap锟斤拷锟斤拷canvas锟斤拷锟斤拷 */
		canvas.drawBitmap(this.mask, 0.0F, 0.0F, this.paint);
		/** 锟斤拷锟斤拷锟斤拷锟斤拷锟狡碉拷layer锟斤拷 */
	...
	public Bitmap createOvalBitmap(final int width, final int height) {
		...
		/**
		 * 锟斤拷锟斤拷锟斤拷圆锟侥达拷小(锟斤拷为锟斤拷圆锟斤拷锟斤拷锟斤拷呋锟斤拷border锟斤拷锟斤拷锟斤拷锟斤拷睾系模锟斤拷锟斤拷图片锟斤拷锟斤拷叩锟斤拷锟缴拷锟斤拷睿拷锌锟斤拷锟斤拷
		 * 锟斤拷锟竭碉拷效锟斤拷锟斤拷锟斤拷锟斤拷为锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷雍茫锟? 锟斤拷锟斤拷锟斤拷锟斤拷padding px)
		 */
